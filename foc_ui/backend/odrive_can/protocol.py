...
class CalibrationSessionItem(IntEnum):
    ...
    VERNIER_MAIN_OFFSET_RAD = 0x48
    VERNIER_AUX_OFFSET_RAD = 0x49
    VERNIER_FIT_RMS_RAD = 0x4A
    VERNIER_WORST_RESIDUAL_RAD = 0x4B
    VERNIER_MINIMUM_MARGIN_RAD = 0x4C
    VERNIER_USED_SAMPLES = 0x4D
